					...
					<div class="row g-0">
					  ...
					  <div class="col-md-8">
						...
						<div class="d-flex gap-3 mt-3">
							<a href="{{ asset('#') }}" class="btn btn-primary">Buy Now</a>
							<a href="{{ asset('#') }}" class="btn btn-outline-primary"><span class="text">Add to cart</span> <i class='bx bxs-cart-alt'></i></a>
						</div>
						</div>
					  </div>
					</div>
					...
					<div class="card-body">
						<ul class="nav nav-tabs nav-primary mb-0" role="tablist">
							<li class="nav-item" role="presentation">
								<a class="nav-link active" data-bs-toggle="tab" href="{{ asset('#primaryhome') }}" role="tab" aria-selected="true">
							...
							<li class="nav-item" role="presentation">
								<a class="nav-link" data-bs-toggle="tab" href="{{ asset('#primaryprofile') }}" role="tab" aria-selected="false">
									<div class="d-flex align-items-center">
							...
							<li class="nav-item" role="presentation">
								<a class="nav-link" data-bs-toggle="tab" href="{{ asset('#primarycontact') }}" role="tab" aria-selected="false">
									<div class="d-flex align-items-center">
